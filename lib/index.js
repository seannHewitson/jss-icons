...
var useStyles$9 = createUseStyles(function (Theme) { return ({
    icon: {
        position: 'relative',
    ...
    defaultIcon: {
        ...
        maxWidth: '1em',
        height: function (_a) {
            var _b = _a === void 0 ? Theme : _a, bold = _b.bold;
            return bold ? '.125em' : '.1em';
        },
...
var Icon = function (props) {
    var bold = props.bold, condition = props.condition, conditionIcon = props.conditionIcon, icon = props.icon, rest = __rest(props, ["bold", "condition", "conditionIcon", "icon"]);
    var _a = React.useState([icon]), classList = _a[0], setClassList = _a[1];
    var classes = useStyles$9({ bold: bold });
    React.useEffect(function () {
        if (condition === true && conditionIcon !== undefined) {
            return setClassList(__spreadArray(__spreadArray([], classList), [conditionIcon]));
        }
        setClassList(classList.filter(function (c) { return c !== conditionIcon; }));
    }, [condition, conditionIcon]);
    return (React__default['default'].createElement("span", __assign({ className: classes.icon, onClick: onclick }, rest),
        React__default['default'].createElement("i", { className: classes.defaultIcon + " " + classList.join(' ') })));
};
...
var upArrowProps = { dir: 'up' };
var downArrowProps = { dir: 'down' };
var leftArrowProps = { dir: 'left' };
var rightArrowProps = { dir: 'right' };
var horizontalArrowProps = { dir: 'horizontal' };
var verticalArrowProps = { dir: 'vertical' };
var Arrow = function (props) {
    var _a;
    if (props === void 0) { props = rightArrowProps; }
    var dir = (_a = props.dir) !== null && _a !== void 0 ? _a : 'right';
    var classes = useStyles$8();
    return classes.arrow + " " + dir;
};
var UpArrow = function () { return Arrow(upArrowProps); };
var DownArrow = function () { return Arrow(downArrowProps); };
var LeftArrow = function () { return Arrow(leftArrowProps); };
var RightArrow = function () { return Arrow(rightArrowProps); };
var HorizontalArrow = function () { return Arrow(horizontalArrowProps); };
var VerticalArrow = function () { return Arrow(verticalArrowProps); };
var ArrowIcon = function (props) {
    var dir = props.dir, rest = __rest(props, ["dir"]);
    var arrowDir = dir !== null && dir !== void 0 ? dir : 'right';
    var classes = useStyles$8();
    return React__default['default'].createElement(Icon, __assign({ icon: classes.arrow + " " + arrowDir }, rest));
};
var UpArrowIcon = function (props) { return ArrowIcon(__assign(__assign({}, upArrowProps), props)); };
var DownArrowIcon = function (props) { return ArrowIcon(__assign(__assign({}, downArrowProps), props)); };
var LeftArrowIcon = function (props) { return ArrowIcon(__assign(__assign({}, leftArrowProps), props)); };
var RightArrowIcon = function (props) { return ArrowIcon(__assign(__assign({}, rightArrowProps), props)); };
var HorizontalArrowIcon = function (props) { return ArrowIcon(__assign(__assign({}, horizontalArrowProps), props)); };
var VerticalArrowIcon = function (props) { return ArrowIcon(__assign(__assign({}, verticalArrowProps), props)); };
...
var BeehiveIcon = function (props) {
    var classes = useStyles$7();
    return (React__default['default'].createElement(Icon, __assign({ icon: "" + classes.beehive }, props)));
};
...
var CheckIcon = function (props) {
    var classes = useStyles$6();
    return (React__default['default'].createElement(Icon, __assign({ icon: "" + classes.check }, props)));
};
...
var upChevronProps = { dir: 'up' };
var downChevronProps = { dir: 'down' };
var leftChevronProps = { dir: 'left' };
var rightChevronProps = { dir: 'right' };
var Chevron = function (props) {
    var _a;
    if (props === void 0) { props = rightChevronProps; }
    var dir = (_a = props.dir) !== null && _a !== void 0 ? _a : 'right';
    var classes = useStyles$5();
    return classes.chevron + " " + dir;
};
var UpChevron = function () { return Chevron(upChevronProps); };
var DownChevron = function () { return Chevron(downChevronProps); };
var LeftChevron = function () { return Chevron(leftChevronProps); };
var RightChevron = function () { return Chevron(rightChevronProps); };
var ChevronIcon = function (props) {
    var dir = props.dir, rest = __rest(props, ["dir"]);
    var chevronDir = dir !== null && dir !== void 0 ? dir : 'right';
    var classes = useStyles$5();
    return React__default['default'].createElement(Icon, __assign({ icon: classes.chevron + " " + chevronDir }, rest));
};
var UpChevronIcon = function (props) { return ChevronIcon(__assign(__assign({}, upChevronProps), props)); };
var DownChevronIcon = function (props) { return ChevronIcon(__assign(__assign({}, downChevronProps), props)); };
var LeftChevronIcon = function (props) { return ChevronIcon(__assign(__assign({}, leftChevronProps), props)); };
var RightChevronIcon = function (props) { return ChevronIcon(__assign(__assign({}, rightChevronProps), props)); };
...
var CloseIcon = function (props) {
    var classes = useStyles$4();
    return (React__default['default'].createElement(Icon, __assign({ icon: "" + classes.close }, props)));
};
...
var HamburgerIcon = function (props) {
    var classes = useStyles$3();
    return (React__default['default'].createElement(Icon, __assign({ icon: classes.hamburger }, props)));
};
...
var HamburgerAlt = function () {
    var classes = useStyles$2();
    return classes.hamburgerAlt;
};
var HamburgerAltIcon = function (props) {
    var classes = useStyles$2();
    return (React__default['default'].createElement(Icon, __assign({ icon: classes.hamburgerAlt }, props)));
};
...
var HamburgerAltReverse = function () {
    var classes = useStyles$1();
    return classes.hamburgerAltReverse;
};
var HamburgerAltReverseIcon = function (props) {
    var classes = useStyles$1();
    return (React__default['default'].createElement(Icon, __assign({ icon: classes.hamburgerAltReverse }, props)));
};
...
var PlusIcon = function (props) {
    var classes = useStyles();
    return (React__default['default'].createElement(Icon, __assign({ icon: "" + classes.plus }, props)));
};

exports.Arrow = Arrow;
exports.ArrowIcon = ArrowIcon;
exports.Beehive = Beehive;
exports.BeehiveIcon = BeehiveIcon;
exports.Check = Check;
...
exports.DownChevronIcon = DownChevronIcon;
exports.Hamburger = Hamburger;
exports.HamburgerAlt = HamburgerAlt;
exports.HamburgerAltIcon = HamburgerAltIcon;
exports.HamburgerAltReverse = HamburgerAltReverse;
exports.HamburgerAltReverseIcon = HamburgerAltReverseIcon;
exports.HamburgerIcon = HamburgerIcon;
exports.HorizontalArrow = HorizontalArrow;
exports.HorizontalArrowIcon = HorizontalArrowIcon;
exports.Icon = Icon;
...
exports.UpChevronIcon = UpChevronIcon;
exports.VerticalArrow = VerticalArrow;
exports.VerticalArrowIcon = VerticalArrowIcon;
