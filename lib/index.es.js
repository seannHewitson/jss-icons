...
var Icon = function (props) {
    ...
    var _a = useState([icon]), classList = _a[0], setClassList = _a[1];
    ...
    return (React.createElement("span", __assign({ className: classes.icon, onClick: onclick }, rest),
        React.createElement("i", { className: classes.defaultIcon + " " + classList.join(' ') })));
};
...
var ArrowIcon = function (props) {
    ...
    var classes = useStyles$8();
    return React.createElement(Icon, __assign({ icon: classes.arrow + " " + arrowDir }, rest));
};
...
var BeehiveIcon = function (props) {
    var classes = useStyles$7();
    return (React.createElement(Icon, __assign({ icon: "" + classes.beehive }, props)));
};
...
var CheckIcon = function (props) {
    var classes = useStyles$6();
    return (React.createElement(Icon, __assign({ icon: "" + classes.check }, props)));
};
...
var ChevronIcon = function (props) {
    ...
    var classes = useStyles$5();
    return React.createElement(Icon, __assign({ icon: classes.chevron + " " + chevronDir }, rest));
};
...
var CloseIcon = function (props) {
    var classes = useStyles$4();
    return (React.createElement(Icon, __assign({ icon: "" + classes.close }, props)));
};
...
var HamburgerIcon = function (props) {
    var classes = useStyles$3();
    return (React.createElement(Icon, __assign({ icon: classes.hamburger }, props)));
};
...
var HamburgerAltIcon = function (props) {
    var classes = useStyles$2();
    return (React.createElement(Icon, __assign({ icon: classes.hamburgerAlt }, props)));
};
...
var HamburgerAltReverseIcon = function (props) {
    var classes = useStyles$1();
    return (React.createElement(Icon, __assign({ icon: classes.hamburgerAltReverse }, props)));
};
...
var PlusIcon = function (props) {
    var classes = useStyles();
    return (React.createElement(Icon, __assign({ icon: "" + classes.plus }, props)));
};

export { Arrow, ArrowIcon, Beehive, BeehiveIcon, Check, CheckIcon, Chevron, ChevronIcon, Close, CloseIcon, DownArrow, DownArrowIcon, DownChevron, DownChevronIcon, Hamburger, HamburgerAlt, HamburgerAltIcon, HamburgerAltReverse, HamburgerAltReverseIcon, HamburgerIcon, HorizontalArrow, HorizontalArrowIcon, Icon, LeftArrow, LeftArrowIcon, LeftChevron, LeftChevronIcon, Plus, PlusIcon, RightArrow, RightArrowIcon, RightChevron, RightChevronIcon, UpArrow, UpArrowIcon, UpChevron, UpChevronIcon, VerticalArrow, VerticalArrowIcon };
